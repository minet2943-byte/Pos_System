...
function ProductVisual({ category, img, name }) {
  ...
  return (
    <div className={`customer-product-visual ${isMask ? 'mask' : ''} ${img ? 'has-image' : ''}`}>
      {img ? (
...
export default function Customers() {
  ...
  const [paymentSecondsLeft, setPaymentSecondsLeft] = useState(paymentDurationSeconds)
  ...
  const discount = promotion === 'member' && customerType === 'member' ? subtotal * memberDiscountRate : 0
  ...
  return (
    <section className="customer-pos-page">
          ...
          <section className="customer-products-panel" aria-label="Product catalog">
            ...
            <div className="customer-product-grid">
              {visibleProducts.map((product) => (
                ...
                >
                  <ProductVisual category={product.category} img={product.img} name={product.name} />
      ...
      {isCheckoutOpen && (
        <div className="customer-payment-overlay" role="dialog" aria-modal="true" aria-labelledby="payment-title">
          <section className="customer-payment-modal">
            <div className="customer-payment-header">
              ...
              <button type="button" onClick={() => setIsCheckoutOpen(false)} aria-label="Close payment">
                x
              </button>
            </div>
            ...
            <div className="customer-payment-total">
              ...
              <div className={isPaymentExpired ? 'customer-payment-timer expired' : 'customer-payment-timer'}>
            ...
            <div className="customer-payment-methods" aria-label="Payment method">
            ...
            <div className="customer-payment-qr">
              <div className="customer-qr-code">
                <img alt={`${paymentMethod} payment QR`} src={selectedQrImage} />
              </div>
            ...
            <div className="customer-payment-actions">
              <button type="button" className="customer-save-qr" onClick={handleSaveQr}>
                Save QR
              </button>
            </div>
